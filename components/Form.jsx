...
function Form() {
  ...
  return (
    <div
      className={
        modality
          ? ` h-full w-full flex items-center justify-center fixed z-50 backdrop-blur-lg `
          : `hidden overflow-hidden`
      }
    >
      <form className="bg-white text-black rounded-xl px-[50px] relative max-w-[654px] flex flex-col gap-y-[10px] mx-2 md:mx-0">
        ...
        {/* first line */}
        <div className="grid grid-cols-2  outfit md:text-[15px] text-[13px]  w-full gap-x-[10px]">
        ...
        {/* third line */}
        <div className="grid grid-cols-2 w-full  md:text-[15px] text-[13px]  outfit gap-x-[10px]">
          <div className="flex flex-col">
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 w-full gap-x-[10px] mt-[20px] mb-[50px]">
          <div className="outfit md:text-[15px] text-[13px] flex gap-x-[6px] items-start md:order-2 pb-[10px] md:pb-0">
            ...
            />
            <label for="agree">
              I agree to receive updates and marketing communications from Salle
              Privée / Event Spaces
            </label>
          </div>
          <div>
